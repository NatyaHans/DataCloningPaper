#!/bin/sh
#SBATCH --job-name=HiSSECetPOST  #Job name
...
#SBATCH -o HiSSECetPOST.%j.out # Name output file
#SBATCH
...
Rscript /blue/burleigh/nhans/GitHubNH/DataCloning/HiSSE/Scripts2/Hissefit_cetacean_forcluster_posteriorONLY.R 
